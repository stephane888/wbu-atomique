...
if (window.Stripe) {
  (function ($, Drupal) {
    function init(context, settings) {
      ...
      once("stripebyhabeuk_add_cart", "#" + configs.idhtml, context).forEach((item) => {
          ...
          .then((paymentIntent) => {
            ...
            if (form) {
              ...
              form.addEventListener("submit", async (event) => {
                if (form.getElementById("payment-method-id" + configs.idhtml).value.length > 0) {
                  return true;
                }
                ...
                stripe
                  ...
                  .then(({ paymentMethod, error }) => {
                    ...
                    if (paymentMethod) {
                      ...
                      form.getElementById("payment-method-id" + configs.idhtml).value = paymentMethod.id;
                      // Submit the form.
